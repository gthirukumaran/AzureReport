# Variables
$DiskID = "# eg. "/subscriptions/xxxxxxxxxxxxx/resourcegroups/rg-server1-prod-1/providers/Microsoft.Compute/disks/testserver1"
$VMName = "testServer1"
$DiskSizeGB = 50
$AzSubscription = "shared Subscription"
